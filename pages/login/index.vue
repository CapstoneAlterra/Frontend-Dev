    ...
    <form class="mt-8 space-y-6" action="#" method="POST">
      ...
      <div class="rounded-md shadow-sm -space-y-px">
        ...
        <div class="textbox2">
          ...
          <input type="password" placeholder="Password" class=" border w-full h-5 px-3 py-5 mt-5 hover:outline-none focus:outline-none focus:ring-1 focus:ring-indigo-600 rounded-md">
        </div>
      </div>
      ...
      <div class="flex items-center justify-between">
        ...
        <div class="text-sm">
          <a href="#" class="font-medium text-grey-600 hover:text-grey-500"> Forgot your password? </a>
        </div>
      </div>
