    ...
    <div class="py-4 px-3 bg-white border-r-2 border-gray-200">
      ...
      <ul class="space-y-2">
        <li>
          ...
          >
            <svg
              class="flex-shrink-0 w-6 h-6 text-black dark:text-gray-400 hover:text-white dark:group-hover:text-black"
              fill="currentColor"
              viewBox="0 0 20 20"
        ...
        <li>
          ...
          >
            ...
            <span class="flex-1 ml-3 whitespace-nowrap"
              >Manage offline Class</span
            >
          </nuxt-link>
        </li>
        <li>
          <nuxt-link
            to="/admin/onlineClass"
            class="flex items-center p-2 text-base font-normal text-black rounded-lg hover:bg-red-600 hover:text-white"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
